...
const Users = ({setMessages, setSelectedUser, selectedUser}:
                   {
    ...
    const handleChangeChatClick = async (event, id: string) => {
                                            ...
                                            <Avatar alt="Remy Sharp"
                                                    src={
                                                        u.image.slice(0, 8) === 'https://'
                                                            ?
                                                            u.image
                                                            : `https://storage.googleapis.com/social_todos/${u.image || 'users/default-avatar.jpg'}`}/>
                                        </ListItemIcon>
